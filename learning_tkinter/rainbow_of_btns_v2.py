...
class NewButton:
    def __init__(self, master, color, code_color):
        ...
        self.btn = Button(master, bg=self.code_color, activebackground=self.code_color, command=self.get_color, width=2)
        self.btn.pack(anchor=NW, side=LEFT, padx=1, pady=1)
